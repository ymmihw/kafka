...
class CountryPopulationConsumerUnitTest {
  ...
  void setUp() {
    ...
    countryPopulationConsumer =
        new CountryPopulationConsumer(consumer, ex -> this.pollException = ex, updates::add);
  }
  ...
  private ConsumerRecord<String, Integer> record(
      String topic, int partition, String country, int population) {
